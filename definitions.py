...
PINGS500_SET_DEVICE_ID = 1000
PINGS500_SET_SPEED_OF_SOUND = 1002
PINGS500_SET_PING_PARAMS = 1015
PINGS500_FW_VERSION = 1200
PINGS500_SPEED_OF_SOUND = 1203
PINGS500_RANGE = 1204
PINGS500_PING_RATE_MSEC = 1206
PINGS500_GAIN_INDEX = 1207
PINGS500_ALTITUDE = 1211
PINGS500_PROCESSOR_DEGC = 1213

# variable length fields are formatted with 's', and always occur at the end of the payload
# the format string for these messages is adjusted at runtime, and 's' inserted appropriately at runtime
# see PingMessage.get_payload_format()
payload_dict_pings500 = {
    PINGS500_SET_DEVICE_ID: {
        "name": "set_device_id",
        "format": "B",
        "field_names": (
             "device_id",
...
payload_dict_all.update(payload_dict_pings500)
